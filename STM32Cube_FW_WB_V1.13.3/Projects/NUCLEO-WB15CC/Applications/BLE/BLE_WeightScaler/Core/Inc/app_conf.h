 ...
 */
#define CFG_BLE_NUM_GATT_SERVICES   5 /* 4 */
 ...
 */
#define CFG_BLE_NUM_GATT_ATTRIBUTES 35 /* 30 */
 ...
 * This parameter is ignored by the CPU2 when CFG_BLE_OPTIONS is set to 1"
 */
#define CFG_BLE_ATT_VALUE_ARRAY_SIZE    (960) /* (960) */ /* (1024) */  /* (1290) */
 ...
 */
#define DBG_TRACE_MSG_QUEUE_SIZE 1024 /* 4096 */
#define MAX_DBG_TRACE_MSG_SIZE 512 /* 1024 */
...
/* Add Weight Scale Service in Application */
#define APP_ENABLE_WSS
/* Add Device Information Service in Application */
//#define APP_ENABLE_DIS
/* Add Body Composition Service in Application */
#define APP_ENABLE_BCS
/* Add User Data Service in Application */
#define APP_ENABLE_UDS
/* Add Current Time in Application */
//#define APP_ENABLE_CTS
/* Add Battery Service */
//#define APP_ENABLE_BAS

#define SUPPORT_MULTI_USERS
//#define UDS_SINGLE_TRUSTED_COLLECTOR
...
typedef enum
{
	...
	/* WSS Measurement */
    CFG_TASK_WSS_MEAS_REQ_ID,
	/* BCS Measurement */
    CFG_TASK_BCS_MEAS_REQ_ID,
	/* UDS User Control Point */
	CFG_TASK_UDS_CRL_MSG_ID,
	CFG_TASK_UDS_REG_NEW_ID,
	CFG_TASK_UDS_CONSENT_ID,
	CFG_TASK_UDS_DEL_USER_ID,
	/* Current Time Notify */
	CFG_TASK_CTS_NOTIFY_ID,
