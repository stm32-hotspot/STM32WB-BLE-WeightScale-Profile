...
#define BLE_DBG_BCS_EN             1
#define BLE_DBG_UDS_EN             1
#define BLE_DBG_WSS_EN             1
#define BLE_DBG_CTS_EN             1
...
#if (BLE_DBG_BCS_EN != 0)
#define BLE_DBG_BCS_MSG             PRINT_MESG_DBG
#else
#define BLE_DBG_BCS_MSG             PRINT_NO_MESG
#endif

#if (BLE_DBG_UDS_EN != 0)
#define BLE_DBG_UDS_MSG             PRINT_MESG_DBG
#else
#define BLE_DBG_UDS_MSG             PRINT_NO_MESG
#endif
