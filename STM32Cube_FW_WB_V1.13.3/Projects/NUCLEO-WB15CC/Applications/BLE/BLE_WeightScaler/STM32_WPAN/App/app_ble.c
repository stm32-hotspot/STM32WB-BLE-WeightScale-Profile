...
#include "stm32_lpm.h"
#include "otp.h"
#ifdef APP_ENABLE_DIS
#include "dis.h"
#include "dis_app.h"
#endif /* APP_ENABLE_DIS */
#ifdef APP_ENABLE_WSS
#include "wss.h"
#include "wss_app.h"
#endif /* APP_ENABLE_WSS */
#ifdef APP_ENABLE_BCS
#include "bcs.h"
#include "bcs_app.h"
#endif /* APP_ENABLE_BCS */
#ifdef APP_ENABLE_UDS
#include "uds.h"
#include "uds_app.h"
#endif /* APP_ENABLE_UDS */
#ifdef APP_ENABLE_CTS
#include "cts.h"
#include "cts_app.h"
#endif /* APP_ENABLE_CTS */
#ifdef APP_ENABLE_BAS
#include "bas.h"
#include "bas_app.h"
#endif /* APP_ENABLE_BAS */
...
#define BONDING_TIMEOUT                (10*1000*1000/CFG_TS_TICK_VAL) /**< 10s */
...
static const char local_name[] = {AD_TYPE_COMPLETE_LOCAL_NAME ,'W','S','S','T','M'};
...
/* USER CODE END APP_BLE_Init_1 */
  ...
  /* for WSP/SEN/WSF/BV-06-I [Weight and Height not present in Body Composition Features] */
  //BCSAPP_RemoveFeature(BCS_FEATURE_WEIGHT | BCS_FEATURE_HEIGHT);
#endif /* APP_ENABLE_BCS */
...
/* USER CODE END APP_BLE_Init_3 */
  ...
  APP_DBG_MSG("Complete Bonding, make device discoverable\n\r");
  ...
  Add_Advertisment_Service_UUID(WEIGHT_SCALE_SERVICE_UUID);
    ...
    case HCI_LE_META_EVT_CODE:
    {
      ...
      switch (meta_evt->subevent)
      {
        case HCI_LE_CONNECTION_UPDATE_COMPLETE_SUBEVT_CODE:
          APP_DBG_MSG("** CONNECTION UPDATE EVENT WITH CLIENT \n\r");
          APP_DBG_MSG("\n\r");
...
{
	UTIL_SEQ_SetTask( 1<< CFG_TASK_CTS_NOTIFY_ID, CFG_SCH_PRIO_0);
}
...
static void Ble_Hci_Gap_Gatt_Init(void){
  ...
  if (role > 0)
  {
    ...
    {
      APP_DBG_MSG("  Success: aci_gap_init command for %s\n\r", name);
    }
...
static void Adv_Request(APP_BLE_ConnStatus_t New_Status)
{
  ...
  else
  {
    ...
    APP_DBG_MSG("\n\r");
    APP_DBG_MSG("Start Fast or Low Power Advertising \n\r");
